...
//};
    ...
    FrE FrE::AddMod(const FrE& a, const FrE& b)
    {
        FrE c{};
        AddOverflow(a,b,&c);
    ...
    FrE FrE::SubMod(const FrE& a, const FrE& b)
    {
        FrE c{};
    ...
    FrE FrE::MultiplyMod(const FrE& x, const FrE& y)
    {
        ulong t[4] = {0,0,0,0};
        ulong c[3] = {0,0,0};
        ulong z[4] = {0,0,0,0};
    ...
    {
        FrE x = {u0,u1,u2,u3};
        return FrE::MultiplyMod(x, rSquare);
    }
    ...
    {
        return FrE::SubMod(FrE{0,0,0,0}, a);
    }
    ...
    static FrE FromBytesReduced(const uint8_t* bytes, bool isBigEndian = false)
    {
        ...
        res = Mod(res);
        return FrE::MultiplyMod(res, rSquare);
    }
    ...
    static FrE Exp(const FrE& b, const FrE& e)
    {
        ...
        for (int i = 0; i < len; i++)
        {
            if (e.Bit(i)) result = FrE::MultiplyMod(result, bs);

            bs = FrE::MultiplyMod(bs, bs);
        }
        return result;
    }
